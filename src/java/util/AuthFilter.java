    ...
    try {
      ...
      if (reqURI.indexOf("/index.xhtml") >= 0 || reqURI.indexOf("/about.xhtml") >= 0
        ...
        chain.doFilter(request, response);
              ...
              || (ses != null && ses.getAttribute("username") != null && ses.getAttribute("roleName").equals("customer") && reqURI.indexOf("/customer/") >= 0)
              || reqURI.indexOf("/user/") >= 0 || reqURI.contains("javax.faces.resource")) {
        chain.doFilter(request, response);
      } 
//      else if (reqURI.indexOf("/login.xhtml") >= 0 || reqURI.indexOf("/about.xhtml") >= 0
